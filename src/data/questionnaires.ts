      ...
      options: [
        {
          ...
          patch: { commitment: "mini", maxSeasons: 1, seriesStatus: "ended", softPreferences: ["fewSeasons", "strongEnding"] },
        },
        {
          id: "small",
          emoji: "📺",
          label: "PETITE SÉRIE",
          hint: "1 à 2 saisons",
          patch: { commitment: "small", minSeasons: 1, maxSeasons: 2, softPreferences: ["fewSeasons"] },
        },
        {
          id: "medium",
          emoji: "🍿",
          ...
          patch: { commitment: "medium", minSeasons: 3, maxSeasons: 5 },
        },
        {
          id: "long",
          emoji: "🏠",
          ...
          patch: { commitment: "long", minSeasons: 4 },
        },
      ],
    },
    {
